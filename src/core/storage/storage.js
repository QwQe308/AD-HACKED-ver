...
export const GameStorage = {
  ...
  get localStorageKey() {
    return DEV ? "dimensionHackedTestSave" : "dimensionHackedSave";
  },

  backupDataKey(saveSlot, backupSlot) {
    return DEV ? `HackedBackupTestSave-${saveSlot}-${backupSlot}` : `HackedBackupSave-${saveSlot}-${backupSlot}`;
  },

  backupTimeKey(saveSlot) {
    return DEV ? `HackedBackupTestTimes-${saveSlot}` : `HackedBackupTimes-${saveSlot}`;
  },
